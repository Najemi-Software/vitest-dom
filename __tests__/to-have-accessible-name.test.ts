...
describe(".toHaveAccessibleName", () => {
    ...
    `);
        ...
        expect(button).toHaveAccessibleName(expect.stringContaining("Continue to the next"));
   ...
   `);
        ...
        expect(firstNameField).toHaveAccessibleName(expect.stringContaining("First"));
        expect(() => {
        ...
        expect(checkboxField).toHaveAccessibleName(expect.stringContaining("Accept terms"));
        expect(() => {
   ...
   `);
        ...
        expect(firstNameField).toHaveAccessibleName(expect.stringContaining("your name"));
        expect(() => {
            expect(firstNameField).toHaveAccessibleName("First name");
        }).toThrow(/expected element to have accessible name/i);
        expect(() => {
        ...
        expect(() => {
            expect(checkboxField).not.toHaveAccessibleName("Accept our terms and conditions");
        }).toThrow(/expected element not to have accessible name/i);
